...
public class VnAbout extends javax.swing.JDialog{
    ...
    private void initComponents() {
        ...
        lbImagen = new JLabel();
        lbImagen.setIcon(new ImageIcon("src/main/java/resources/data/Iconos/1x/Acerca_de.PNG"));
        if(ancho < 1500){
            lbImagen.setIcon(new ImageIcon("src/main/java/resources/data/Iconos/1x/Acerca_de_min.png"));
        }
