...
public class PnDiagramaVenn extends JPanel {
    ...
    private void crearPanel() {
        ...
        if (ancho < 1500) {
            ...
            lbIcono.setIcon(new ImageIcon("src/main/java/resources/data/Iconos/1x/Proximamente_1366.png"));
        } else {
            lbTitulo.setFont(PatronDisenho.SEGOE_16);
            lbIcono.setIcon(new ImageIcon("src/main/java/resources/data/Iconos/1x/Proximamente_1920.png"));
        }
