...
public class PnCabecera extends JPanel {
    ...
    private void crearPanel() {
        ...
        if (ancho < 1500) {
            ...
            espacio.setIcon(new ImageIcon("src/main/java/resources/data/Iconos/1x/Icono-cabecera-37x37.png"));
        } else {
            tituloCabecera.setFont(PatronDisenho.SEGOE_18);
            espacio.setIcon(new ImageIcon("src/main/java/resources/data/Iconos/1x/Icono-cabecera-50x50.png"));
        }
