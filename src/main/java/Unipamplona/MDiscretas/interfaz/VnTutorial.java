...
public class VnTutorial extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        this.setIconImage(new ImageIcon("src/main/java/resources/data/Iconos/1x/Icono-cabecera-50x50.png").getImage());
        ...
        lbImagenRelaciones.setIcon(new ImageIcon("src/main/java/resources/data/Iconos/1x/tutorial_Relaciones_max.png"));
        if (ancho < 1500) {
            lbImagenRelaciones.setIcon(new ImageIcon("src/main/java/resources/data/Iconos/1x/tutorial_Relaciones_min.png"));
        }
        ...
        lbImagenConjuntos.setIcon(new ImageIcon("src/main/java/resources/data/Iconos/1x/tutorial_conjuntos_max.png"));
        if (ancho < 1500) {
            lbImagenConjuntos.setIcon(new ImageIcon("src/main/java/resources/data/Iconos/1x/Icono-tutorial_conjuntos_min.png"));
        }
